...
<body>
   ...
   <center> <h3 class="titulop">Cursos Desarrollo |<a href="blog.php">Blog</a></h3></center>
   ...
   <div class="containertar">
     <?php echo $mensaje;?>
             <?php
               $sentencia=$pdo->prepare("SELECT * FROM `tblproductosdesarrollo`");
               $sentencia->execute();
        ...
        <div class="card">
         ...
         <br>
            ...
            <input type="hidden" name="cantidad" id="cantidad" value="<?php echo openssl_encrypt(1,COD,KEY);?>">
                ...
                <?php } ?>  
                <div class="card">
           <img src="Img/laravel-5.png">
           <h4>Master Laravel</h4>
           <b>Jorge Luis García Coello</b>
           <center>
           <fieldset class="val-fieldset"><span class="valoracion val-25"></span></fieldset></center>
           <br>
         
            <a href="ptarjetalaravel5.php">¡Muy Pronto! |💥 ¡Oferta por lanzamiento!</a>
...
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>   <?php include 'partials/footer.php';?>