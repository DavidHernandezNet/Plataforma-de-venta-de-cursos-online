...
<body>
   ...
   <center> <h3 class="titulop">Cursos Marketing |<a href="blog.php"> Blog</a></h3></center>
   ...
   <div class="containertar">
     <?php echo $mensaje;?>
             <?php
               $sentencia=$pdo->prepare("SELECT * FROM `tblproductosmkt`");
               $sentencia->execute();
        ...
        <div class="card">
         ...
         <br>
            ...
            <input type="hidden" name="cantidad" id="cantidad" value="<?php echo openssl_encrypt(1,COD,KEY);?>">
                ...
                <?php } ?>  
                <div class="card">
           <img src="Img/8e1fa85d-3e17-4e61-b920-298e8eeb65e5-14c38852905a.small.png">
           <h4>Fundamentos del Maketing Digital</h4>
           <b></b>
           <center>
           <fieldset class="val-fieldset"><span class="valoracion val-0"></span></fieldset></center>
           <br>
            <a href="#"> 🕒 ¡Muy pronto!</a>
       </div>
                </div>   
