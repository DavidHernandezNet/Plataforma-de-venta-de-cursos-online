...
<body>
   ...
   <center> <h3 class="titulop">Cursos Matematicas |<a href="blog.php"> Blog</a></h3></center>
   ...
   <div class="containertar">
     <?php echo $mensaje;?>
             <?php
               $sentencia=$pdo->prepare("SELECT * FROM `tblproductosmat`");
               $sentencia->execute();
...
<br><br><br><br><br><br><br><br><br><br>   <?php include 'partials/footer.php';?>